...
namespace MVC_project.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CustomerId,CustomerName,Address,Number")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerId,CustomerName,Address,Number")] Customer customer)
        {
            if (ModelState.IsValid)
            {
